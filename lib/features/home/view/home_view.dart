...
class MxhView extends StatefulWidget {
  static route() => MaterialPageRoute(
        builder: (context) => const MxhView(),
      );
  const MxhView({super.key});

  @override
  State<MxhView> createState() => _MxhViewState();
}

class _MxhViewState extends State<MxhView> {
  int _page = 0;
