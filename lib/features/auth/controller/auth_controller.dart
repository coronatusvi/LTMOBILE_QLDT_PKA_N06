...
class AuthController extends StateNotifier<bool> {
  ...
  void signUp({
    ...
    res.fold(
      ...
      (r) async {
        UserModelMxh userModel = UserModelMxh(
          email: email,
  ...
  Future<void> login({
    ...
    res.fold(
      (l) => showSnackBar(context, l.message),
      (r) {
        Navigator.push(context, MxhView.route());
      },
    );
  }

  Future<UserModelMxh> getUserData(String uid) async {
    final document = await _userAPI.getUserData(uid);
    final updateUser = UserModelMxh.fromMap(document.data);
    return updateUser;
  }
